...
// Интерфейс для маппинга специальностей на их UUID
...
// Маппинг названий специальностей на их UUID
           ...
           <div className="relative" ref={specialtyDropdownRef}>
             <button
               ...
               className={`
                 ...
                 focus:outline-none
                 ${borderColor} ${inputBg} ${textColor}
                 ${(!selectedService || loading) ? 'opacity-50 cursor-not-allowed' : ''}
               `}
             >
               {loading ? t('loading') : selectedSpecialty || (selectedService === 'doctor' ? t('selectSpecialty') : 
                                   selectedService === 'analysis' ? t('selectAnalysisType') : 
                                   selectedService === 'checkup' ? t('selectCheckupProgram') : 
                                   t('selectSpecialty'))}
               <ArrowDownIcon 
             ...
             {isSpecialtyDropdownOpen && selectedService && !loading && (
               <div className={`
                 absolute z-20 mt-1 w-full
                 rounded-xl shadow-lg border 
