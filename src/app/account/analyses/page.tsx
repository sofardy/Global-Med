          ...
          {testResults.map((result) => (
            ...
            >
              ...
              <div className="hidden sm:grid sm:grid-cols-3">
                ...
                <div className="col-span-1">
                  <div className="text-[#094A54] dark:text-dark-text font-medium">{result.doctor}</div>
                  <div className="text-[#094A5480] dark:text-dark-text/80 text-sm mt-2">{result.doctorName}</div>
                </div>
