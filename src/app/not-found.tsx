...
export default function NotFound() {
  ...
  const { currentLocale, setLocale }: any = useLanguageStore();
  const translations: any = {
    ...
    uz: {
      ...
      message:
        "Noto‘g‘ri kiritilgan manzil yoki bunday sahifa endi mavjud emas",
      backToHome: "Bosh sahifaga qaytish",
    },
    en: {
      title: "Page not found",
      message: "Incorrect address or such a page no longer exists",
      backToHome: "Back to home",
    },
  };
  const t: any = translations[currentLocale];
  return (
