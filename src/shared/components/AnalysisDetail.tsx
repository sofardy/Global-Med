...
const translations = {
  ...
  en: {
    ...
    tests: "tests",
    prepareTitle: "How to prepare for the analysis",
    prepareDesc:
      "It is important to prepare correctly for the analysis to get accurate results",
    preparationSteps: [
      "Blood should be drawn in the morning, on an empty stomach (after 8-12 hours of fasting)",
      "Avoid fatty foods and alcohol 1-2 days before the blood test",
    ...
    indicatorsTitle: "Main indicators",
    indicators: [
      {
        name: "INR (International Normalized Ratio)",
        description: "Measures the extrinsic pathway of blood coagulation",
        norm: "0.85 - 1.25",
      },
      {
        name: "Prothrombin Time (PT)",
        description: "Measures the time needed for clot formation",
        norm: "11 - 16 sec",
      },
      {
        name: "APTT (Activated Partial Thromboplastin Time)",
        description: "Measures the intrinsic pathway of blood coagulation",
        norm: "26 - 36 sec",
      },
      {
        name: "Thrombin Time (TT)",
        description: "Shows the time of fibrinogen conversion to fibrin",
        norm: "15 - 22 sec",
      },
      {
        name: "Fibrinogen",
        description: "Protein involved in the final stage of blood clotting",
        norm: "1.8 - 4.0 g/l",
      },
      {
        name: "D-dimer",
        description: "Product of fibrin degradation, a marker of thrombosis",
        norm: "< 0.5 µg/ml",
      },
    ],
    ...
    analysisDetails: {
      coagulogram: {
        title: "Coagulogram",
        description:
          "Coagulogram is a set of tests that allow you to assess the clotting ability of the blood and identify possible abnormalities. The coagulogram is important for preventing thrombosis, assessing the condition of the liver, and preparing for surgery.",
        testsCount: 18,
        buttonText: "Book an appointment for analysis",
      },
    },
  },
};
...
const AnalysisDetail: React.FC<AnalysisDetailProps> = ({ params }) => {
  ...
  const analysisData =
    (analysisDetails as any)[id] || analysisDetails.coagulogram;
        ...
        <div className="relative z-10 p-6 sm:p-8 md:p-10 text-white">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            >
              ...
              <span className="absolute inset-0 scale-0 rounded-lg sm:rounded-xl bg-white/40 group-hover:animate-ripple"></span>
            </button>
          </div>
        </div>
      </div>
