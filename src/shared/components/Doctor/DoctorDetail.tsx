...
const translations: LocaleMessages = {
  ru: {
    ...
    certificates: {
      ...
      description:
        "Подтверждения квалификации врача и право на медицинскую практику",
    },
  },
  uz: {
  ...
  en: {
    ...
    certificates: {
      ...
      description:
        "Proof of doctor's qualification and right to medical practice",
    },
  },
};
...
export default function DoctorDetail({
  doctor,
}: DoctorDetailProps): React.ReactElement {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
        <div className="bg-white dark:bg-dark-block rounded-[24px] p-12 shadow-sm flex flex-col h-full">
          ...
          <div className="space-y-6 flex-grow">
            {doctor.basicEducation &&
              doctor.basicEducation.map((edu, index) => (
        ...
        <div className="bg-white dark:bg-dark-block rounded-[24px] p-12 shadow-sm flex flex-col h-full">
          ...
          <div className="space-y-6 flex-grow">
            {doctor.additionalEducation &&
              doctor.additionalEducation.map((edu, index) => (
                <div key={index} className="pb-4 last:pb-0">
                  <div className="font-medium text-[18px] text-[#23464e] dark:text-white mb-1">
                    {edu.course}
                  </div>
