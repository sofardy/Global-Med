...
export const localization = {
  en: {
    contactForm: {
      ...
      subtitle:
        "And we will help you choose an individual solution for your corporate health",
      name: "Name",
      phone: "Phone",
      ...
      confirmationMessage:
        "Please confirm your application submission. Our specialists will contact you shortly.",
  ...
  ru: {
    contactForm: {
      ...
      confirmationMessage:
        "Подтвердите отправку заявки. Наши специалисты свяжутся с вами в ближайшее время.",
  ...
  uz: {
    contactForm: {
      ...
      subtitle:
        "Va biz sizning korporativ sog'liqni saqlash uchun individual yechimni tanlashga yordam beramiz",
      name: "Ism",
      phone: "Telefon",
      ...
      successSubtitle:
        "Klinikamiz mutaxassislari siz bilan tez orada bog'lanadi",
      confirmationTitle: "Ariza tasdiqlash",
      confirmationMessage:
        "Arizani yuborishni tasdiqlang. Bizning mutaxassislarimiz tez orada siz bilan bog'lanadi.",
  ...
  return (
    <>
      <div
        ...
        className={`w-full flex flex-col md:flex-row gap-5 mt-20 overflow-hidden`}
      >
        <div
