...
import { ArrowDownIcon, Clock24Icon, LogoIcon, UserIcon, PhoneIcon, WhatsappIcon, LogoTextIcon } from '../../ui/Icon';
              ...
              {languages.map((lang) => (
                ...
                >
                  <div className="w-8 h-6 mr-2 flex items-center">
                    {lang.code === 'uz' && <img src="/icon/icon-uzbekistan.svg" className='w-[20px] h-[14px]' alt="uz" />}
                    {lang.code === 'ru' && <img src="/icon/icon-russia.svg" className='w-[20px] h-[14px]' alt="ru" />}
                  </div>
                  {lang.label}
                </button>
              ))}
