...
export const AppointmentForm = forwardRef<any, AppointmentFormProps>(
  ({ onSuccess, translationNamespace }, ref) => {
    ...
    const getSelectedPurposeText = (purposeKey: string) => {
      ...
      try {
        const options: Record<string, string> = t("modal.purposeOptions", {
          returnObjects: true,
        });
          ...
          <div className="mb-5">
            <div ref={selectRef} className="relative">
              <div
                ...
                onClick={() =>
                  !isSubmitting && setIsPurposeOpen(!isPurposeOpen)
                }
                tabIndex={0}
                onBlur={(e) => {
              ...
              >
                ...
                <ArrowDownIcon
                  ...
                  className={`transition-transform duration-300 ${
                    isPurposeOpen ? "transform rotate-180" : ""
                  }`}
                />
              </div>
              ...
              {isPurposeOpen && (
                <div className="absolute z-10 mt-1 w-full bg-white dark:bg-gray-800 shadow-lg rounded-xl border border-gray-200 dark:border-gray-700 py-1 max-h-[200px] overflow-auto">
                  {Object.entries(
                    t("modal.purposeOptions", { returnObjects: true })
                  ).map(([key, value]: any) => (
                    <div
                      key={key}
