...
export default function ComprehensiveApproach(): JSX.Element {
  ...
  const serviceCards = serviceCardsData.length > 0 
    ? serviceCardsData.map((item, index) => ({
        title: item.title,
        description: item.subtitle,
        // Если есть SVG в данных, отображаем его, иначе используем иконку по умолчанию
  ...
  return (
    <div className="mt-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <ServiceCard 
            title={serviceCards[3] ? serviceCards[3].title : defaultServiceCards[3].title}
            description={serviceCards[3] ? serviceCards[3].description : defaultServiceCards[3].description}
            icon={serviceCards[3] ? serviceCards[3].icon : defaultServiceCards[3].icon}
          />
        </div>
        <div>
          <ServiceCard 
            title={serviceCards[4] ? serviceCards[4].title : defaultServiceCards[4].title}
            description={serviceCards[4] ? serviceCards[4].description : defaultServiceCards[4].description}
            icon={serviceCards[4] ? serviceCards[4].icon : defaultServiceCards[4].icon}
          />
        </div>
      </div>
    </div>
