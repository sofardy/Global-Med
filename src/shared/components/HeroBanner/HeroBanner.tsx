...
export const HeroBanner: React.FC = () => {
	...
	return (
		<div className="relative w-full h-[500px] sm:h-[500px] md:h-[480px] lg:h-[700px] rounded-2xl overflow-hidden mb-6 sm:mb-8 md:mb-8 mt-4">
			...
			>
				{formSubmitted ? (
					<div className="py-6 flex flex-col items-center justify-center text-center">
						...
						<p className="text-gray-600 dark:text-gray-300 mb-8 text-lg md:text-xl">{t("modal.successMessage")}</p>
						<button
							onClick={closeModal}
