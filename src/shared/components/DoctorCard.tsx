      ...
      <div className="flex flex-col flex-grow">
        ...
        <p
          className={`text-base mb-8 ${
            theme === "light" ? "text-light-text/70" : "text-dark-text/70"
          }`}
        >
          {specialization}
        </p>
        ...
        className={`
          ...
          ${
            isActive
              ...
              : `${
                  theme === "light"
                    ? "border border-light-text text-light-text"
                    : "border border-dark-text text-dark-text"
                }`
          } 
          ${
            !isActive &&
            "hover:bg-light-accent hover:text-white hover:border-light-accent"
          }
        `}
