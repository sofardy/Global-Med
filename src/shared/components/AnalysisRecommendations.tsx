...
const translations = {
  ru: {
    ...
    subtitle: 'Перед сдачей анализов важно соблюдать несколько простых рекомендаций, чтобы результаты были максимально точными',
    recommendations: [
      {
        id: 'food',
  ...
  uz: {
    ...
    subtitle: 'Tahlil topshirishdan oldin natijalar maksimal darajada aniq bo\'lishi uchun bir nechta oddiy tavsiyalarga rioya qilish muhim',
    recommendations: [
      {
        id: 'food',
        title: 'Yog\'li ovqatdan saqlaning',
        description: 'Tahlil topshirishdan bir kun oldin yog\'li ovqat iste\'mol qilmang',
        iconPath: <MedicalIcon />
      },
      {
        id: 'stress',
        title: 'Stressni kamaytiring',
        description: 'Tahlil topshirishdan oldin kuchli stressdan qochishga harakat qiling',
        iconPath: <MedicalIcon />
      },
      {
        id: 'alcohol',
        title: 'Alkogoldan voz keching',
        description: 'Tahlil topshirishdan 24 soat oldin alkogol iste\'mol qilmang',
        iconPath: <MedicalIcon />,
        isActive: true
      },
      {
        ...
        description: 'Tahlil topshirishdan oldin kuchli jismoniy zo\'riqishdan voz keching',
        iconPath: <MedicalIcon />
      }
    ]
  }
...
export default function AnalysisRecommendations() {
  ...
  const recommendations = t('recommendations', { returnObjects: true }) as Recommendation[];
        ...
        {recommendations.map((recommendation: Recommendation) => {
          return (
            <UniversalCard
             ...
             icon={applyColorToIcon(recommendation.iconPath, getIconColorByTheme(theme))}
              showButton={false}
              iconPosition="top"
              minHeight="h-[250px]"
