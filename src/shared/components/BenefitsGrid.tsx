    ...
    return (
      <React.Fragment key={index}>
        ...
        {word}{' '}
            ...
            <a href={readMoreLink} className="relative z-10 h-[58px] inline-flex items-center justify-center border border-[#173F46] dark:border-white text-[#173F46] dark:text-white hover:bg-[#173F46]/5 dark:hover:bg-white/10 rounded-2xl px-6 py-3 transition-colors mt-auto self-start">
