...
export const checkupHeroData = {
  ...
  mainCard: {
    title: "Чек-ап",
    description: "Это комплексное медицинское обследование, которое помогает выявить скрытые заболевания, оценить общее состояние здоровья и предотвратить возможные риски. Мы разработали программы для разных возрастов и потребностей, чтобы вы могли провести диагностику здоровья максимально быстро и комфортно."
  },
  secondaryCards: [
    {
      title: "16",
      description: "видов чек-апов — для мужчин, женщин и детей, включая базовые и специализированные программы"
    },
    {
      title: "1 000+",
      description: "человек ежегодно проходят у нас чек-апы, доверяя экспертам диагностику здоровья"
    }
  ]
};
...
export const checkupDetailTranslations = {
  ru: {
    ...
    description: 'Комплексное обследование перед операцией помогает оценить общее состояние здоровья, выявить возможные риски и подготовить организм к хирургическому вмешательству. Включает ключевые анализы и диагностические исследования, необходимые для безопасного проведения операции и быстрого восстановления.',
    duration: '1,5 часа',
    price: '1 605 000 сум',
    ...
    programDescription: 'Программа диагностики перед операцией включает 11 ключевых исследований, которые помогают получить полную картину состояния организма. Обследование занимает около 1,5 часов, после чего врач сможет оценить результаты и, при необходимости, назначить дополнительные обследования в зависимости от профиля предстоящего хирургического вмешательства.',
    faqItems: [
      {
        title: 'Общий анализ крови',
        content: 'Базовое исследование, которое оценивает количество красных и белых кровяных клеток, гемоглобин, тромбоциты и другие показатели'
      },
      {
        title: 'Общий анализ мочи',
        content: 'Позволяет оценить функцию почек и выявить возможные воспалительные процессы в мочевыводящих путях'
      },
      {
        title: 'Коагулограмма',
        content: 'Коагулограмма — комплексный анализ свертываемости крови. Включает показатели МНО, АЧТВ, фибриногена и протромбинового времени, позволяя оценить риски тромбозов и кровотечений'
      },
      {
        title: 'Рентген легких',
        content: 'Исследование, которое позволяет оценить состояние легочной ткани и выявить патологические изменения'
      },
      {
        title: 'ЭКГ',
        content: 'Электрокардиография — метод исследования электрической активности сердца для выявления нарушений ритма и других патологий'
      },
      {
        title: 'Скрининг на гепатиты, ВИЧ и сифилис',
        content: 'Обязательное исследование перед любым хирургическим вмешательством для оценки инфекционного статуса'
      },
      {
        title: 'Группа крови и резус фактор',
        content: 'Необходимо для подготовки совместимой крови на случай необходимости переливания'
      },
      {
      ...
      },
      {
        ...
        content: 'Ультразвуковое доплерографическое исследование вен для оценки риска тромбоэмболических осложнений'
      },
      {
        title: 'Осмотр терапевта',
        content: 'Консультация специалиста для общей оценки состояния здоровья и возможных рисков'
      },
      {
        title: 'Дополнительные обследования по профилю специалиста',
        content: 'Зависят от характера предстоящей операции и могут включать дополнительные диагностические процедуры'
      }
    ]
  },
  uz: {
    title: 'Chek-ap: Rejali operatsiya',
    description: 'Operatsiyadan oldin kompleks tekshiruv umumiy sog\'liq holatini baholashga, mumkin bo\'lgan xavflarni aniqlashga va organizmni jarrohlik aralashuviga tayyorlashga yordam beradi. O\'z ichiga xavfsiz operatsiya o\'tkazish va tez tiklanish uchun zarur bo\'lgan asosiy tahlillar va diagnostik tekshiruvlarni oladi.',
    duration: '1,5 soat',
    ...
    programDescription: 'Operatsiyadan oldingi diagnostika dasturi organizmning to\'liq holatini baholashga yordam beradigan 11 ta asosiy tekshiruvni o\'z ichiga oladi. Tekshiruv taxminan 1,5 soat davom etadi, shundan so\'ng shifokor natijalarni baholay oladi va zarur bo\'lsa, rejalashtirilgan jarrohlik aralashuvining profiliga qarab qo\'shimcha tekshiruvlarni tayinlashi mumkin.',
    faqItems: [
      {
        title: 'Umumiy qon tahlili',
        content: 'Qizil va oq qon hujayralarining sonini, gemoglobin, trombotsitlar va boshqa ko\'rsatkichlarni baholaydigan asosiy tadqiqot'
      },
      {
        title: 'Umumiy siydik tahlili',
        content: 'Buyraklar funktsiyasini baholash va siydik yo\'llarida potentsial yallig\'lanish jarayonlarini aniqlash imkonini beradi'
      },
      {
        title: 'Koagulogramma',
        content: 'Koagulogramma — qonning ivish qobiliyatining kompleks tahlili. INR, APTT, fibrinogen va protrombin vaqtining ko\'rsatkichlarini o\'z ichiga oladi, bu trombozlar va qon ketishlar xavflarini baholash imkonini beradi'
      },
      {
        title: 'O\'pka rentgeni',
        content: 'O\'pka to\'qimasining holatini baholash va patologik o\'zgarishlarni aniqlash imkonini beradigan tadqiqot'
      },
      {
        title: 'EKG',
        content: 'Elektrokardiografiya — yurak ritmining buzilishini va boshqa patologiyalarni aniqlash uchun yurak elektrik faoliyatini o\'rganish usuli'
      },
      {
        title: 'Gepatitlar, OIV va zaxm uchun skrining',
        content: 'Infektsion holatni baholash uchun har qanday jarrohlik aralashuvidan oldin majburiy tadqiqot'
      },
      {
        title: 'Qon guruhi va rezus omili',
        content: 'Qon quyish zarurati bo\'lgan taqdirda mos keluvchi qonni tayyorlash uchun zarur'
      },
      {
        title: 'Biokimyoviy qon tahlili',
        content: 'Jigar, buyraklar va boshqa organlar funktsiyalarining kompleks baholanishi'
      },
      {
        title: 'Pastki oyoq venalarining UZDG',
        content: 'Tromboembolik asoratlar xavfini baholash uchun venalarning ultratovush doplerografik tekshiruvi'
      },
      {
        title: 'Terapevt ko\'rigi',
        content: 'Umumiy sog\'liq holatini va potentsial xavflarni baholash uchun mutaxassis konsultatsiyasi'
      },
      {
        title: 'Mutaxassis profili bo\'yicha qo\'shimcha tekshiruvlar',
        content: 'Kelgusi operatsiyaning xarakteriga bog\'liq va qo\'shimcha diagnostik protseduralarni o\'z ichiga olishi mumkin'
      }
    ]
  }
};