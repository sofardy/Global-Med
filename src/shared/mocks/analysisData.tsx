...
import { AngelIcon, BrainIcon, ButterflyWingsIcon, CalculatorIcon, CandleIcon, HealthIcon, HemoglobinIcon, ImmuneIcon, LampIcon, MedicalBookHeartIcon, MedicalBookIcon, MedicalIcon, NutritionIcon, PencilRulerIcon, VirusIcon, VirusIconK2 } from '@/src/shared/ui/Icon';
...
export const analysisDetails = {
  coagulogram: {
    ...
    subtitle_desc: 'Каждый тест направлен на выявление различных отклонений в работе крови и позволяет врачу назначить своевременное лечение или профилактику.',
    symptoms_title: 'Симптомы, при которых следует сдать анализы коагулограммы:',
    symptoms: [
    ...
    prices: [
      ...
      { name: 'Агрегация тромбоцитов с АДФ 0,5 мкмоль/л %', price: '9 999 сум' },
      ...
      { name: 'Активное частичное тромбопластиновое время (АЧТВ)', price: '40 000 сум' }
    ],
    recommendations: [
      {
        id: 'biochemistry',
        title: 'Биохимические анализы',
        description: 'Оценка работы внутренних органов, обмена веществ, выявление воспалительных процессов, нарушений липидного обмена',
        icon: 'ButterflyIcon',
        link: '/analysis/biochemistry'
      },
      {
        id: 'hematology',
        title: 'Гематология',
        description: 'Комплексная оценка клеточного состава крови, выявление анемии, инфекций, воспалительных процессов',
        icon: 'BloodCellsIcon',
        link: '/analysis/hematology'
      },
      {
        id: 'hormones',
        title: 'Гормоны',
        description: 'Анализ эндокринной системы, оценка работы щитовидной железы, половых гормонов, надпочечников',
        icon: 'NeuronIcon',
        link: '/analysis/hormones'
      },
      {
        id: 'allergy',
        title: 'Аллергология',
        description: 'Выявление аллергических реакций на различные пищевые, бытовые, пыльцевые аллергены',
        icon: 'ChecklistIcon',
        link: '/analysis/allergy'
      }
    ]
  ...
  biochemistry: {
    title: 'Биохимические анализы',
    description: 'Биохимические анализы крови позволяют оценить работу внутренних органов, выявить нарушения обмена веществ и диагностировать различные заболевания на ранней стадии. С их помощью можно оценить уровень важных показателей, включая ферменты, белки, липиды и электролиты.',
    testsCount: 15,
    buttonText: 'Записаться на сдачу анализов',
    subtitle: 'Биохимические показатели',
    subtitle_desc: 'Биохимические показатели крови позволяют оценить состояние внутренних органов и выявить патологические процессы на ранней стадии.',
    ...
    recommendations: [
      {
        id: 'coagulogram',
        title: 'Коагулограмма',
        description: 'Оценка свертывающей способности крови, выявление риска тромбозов и кровотечений',
        icon: 'ButterflyIcon',
        link: '/analysis/coagulogram'
      },
      {
      ...
      },
      {
        id: 'general-blood',
        title: 'Общий анализ крови',
        description: 'Базовый анализ для оценки состояния крови, выявления инфекций, анемии, воспалений',
        icon: 'BloodCellsIcon',
        link: '/analysis/general-blood'
      },
      {
        id: 'tumor-markers',
        title: 'Онкомаркеры',
        description: 'Ранняя диагностика и мониторинг лечения онкологических заболеваний',
        icon: 'ChecklistIcon',
        link: '/analysis/tumor-markers'
      }
    ]
